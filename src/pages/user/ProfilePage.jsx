        ...
        <div className="bg-white/40 backdrop-blur-xl border border-white/60 rounded-3xl shadow-2xl p-8 mb-6">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              {/* Email hidden from profile view — only visible in Account Settings */}
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 font-medium italic text-sm">Hidden for privacy — visible in Settings</p>
              </div>
            </div>
