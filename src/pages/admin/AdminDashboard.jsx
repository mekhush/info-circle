...
const AdminDashboard = () => {
  ...
  const [newCat, setNewCat] = useState({
    categoryTitle: '', categoryTagLine: '', categoryDescription: '', categoryImage: null,
  });
  ...
  const handleCreateCategory = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        categoryDescription: newCat.categoryDescription,
        ...(newCat.categoryImage && newCat.categoryImage.trim() !== ''
          ? { categoryImage: newCat.categoryImage.trim() }
          : {}),
      };

      const created = await categoryService.createCategory(payload);
      setCategories((prev) => [...prev, created]);
      setNewCat({ categoryTitle: '', categoryTagLine: '', categoryDescription: '', categoryImage: null });
